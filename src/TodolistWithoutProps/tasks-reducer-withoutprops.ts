...
import {v1} from "uuid";
import {addTodolistAC, removeTodolistAC} from "./todolists-reducer-withoutprops";
import {TasksStateType} from "./AppWithReduxWithoutProps";
...
export const tasksReducerWP = (state = initialState, action: ActionType): TasksStateType => {
    debugger
    switch (action.type) {
        case "REMOVE-TASK":
            return {
